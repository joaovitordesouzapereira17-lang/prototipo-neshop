export function ProtoBar() {
  return (
    <div className="bg-ink-900 text-[#cfe0ee] text-[12.5px] text-center py-1.5 px-4 tracking-[.2px]">
      🛠️ <strong className="text-white">PROTÓTIPO / WIREFRAME</strong> — proposta de redesign para validação
