...
export function ProductCard({ product: p }: { product: Product }) {
  ...
  return (
    ...
    >
      <div className="aspect-square bg-bg flex items-center justify-center border-b border-line-soft relative text-ink-300">
        {p.orig && (
      ...
      <div className="p-3.5 pb-4 flex flex-col gap-1.5 flex-1">
        ...
        <span className="text-xs flex items-center gap-1.5">
          <StarRating rating={p.rating} /> <span className="text-ink-500">{p.rating} ({p.reviews})</span>
        </span>
