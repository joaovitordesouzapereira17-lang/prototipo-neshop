      ...
      <section className="py-13">
        <div className="wrap grid md:grid-cols-[1.1fr_.9fr] gap-12 items-center">
          <div>
            ...
            <p className="text-ink-300 text-xs mt-3">Números demonstrativos para fins de protótipo.</p>
          </div>
      ...
      <section className="py-13">
        <div className="wrap">
          ...
          <div className="grid md:grid-cols-3 gap-4.5">
            {CONTENT_CARDS.map((c) => (
              <Link key={c.title} href="/conteudo" className="card p-5.5 hover:border-blue-500 transition-colors">
